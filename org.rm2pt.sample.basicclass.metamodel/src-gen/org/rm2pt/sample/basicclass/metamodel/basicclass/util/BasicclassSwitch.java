/**
 */
package org.rm2pt.sample.basicclass.metamodel.basicclass.util;
 ...
 * @generated
 */
public class BasicclassSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	protected static BasicclassPackage modelPackage;
	 ...
	 * @generated
	 */
	public BasicclassSwitch() {
		if (modelPackage == null) {
			modelPackage = BasicclassPackage.eINSTANCE;
		}
	}
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case BasicclassPackage.CLASS: {
			org.rm2pt.sample.basicclass.metamodel.basicclass.Class class_ = (org.rm2pt.sample.basicclass.metamodel.basicclass.Class) theEObject;
			T result = caseClass(class_);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case BasicclassPackage.PERSON: {
	 ...
	 * @generated
	 */
	public T caseClass(org.rm2pt.sample.basicclass.metamodel.basicclass.Class object) {
		return null;
	}
