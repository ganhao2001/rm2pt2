/**
 */
package org.rm2pt.sample.basicclass.metamodel.basicclass.provider;
...
/**
 * This is the item provider adapter for a {@link org.rm2pt.sample.basicclass.metamodel.basicclass.Person} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PersonItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						BasicclassPackage.Literals.PERSON__NAME, true, false, false,
	...
	protected void addStudentsPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Person_students_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Person_students_feature",
								"_UI_Person_type"),
						BasicclassPackage.Literals.PERSON__STUDENTS, true, false, true, null, null, null));
	}
	...
	protected void addTeachersPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Person_teachers_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Person_teachers_feature",
								"_UI_Person_type"),
						BasicclassPackage.Literals.PERSON__TEACHERS, true, false, true, null, null, null));
	}
	...
	protected void addTeacherPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Person_teacher_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Person_teacher_feature",
								"_UI_Person_type"),
						BasicclassPackage.Literals.PERSON__TEACHER, true, false, true, null, null, null));
	}
	...
	protected void addStudentPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Person_student_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Person_student_feature",
								"_UI_Person_type"),
						BasicclassPackage.Literals.PERSON__STUDENT, true, false, true, null, null, null));
	}
	...
	public ResourceLocator getResourceLocator() {
		return BasicclassEditPlugin.INSTANCE;
	}
